  ...
  return (
    <div className='about'>
      ...
      <p>It gives me great pleasure to welcome you to my website! In case this is your first time here,
        ...
        If you're here on official business, you should find any information about my work <Link className='here' to='my-projects'><b>here.</b>
        </Link><br /><br />
        If you just want to know more about me and how I stumbled across my passion for software development,
            here you go:<br /><br />
        Since my childhood I have been very keen on understanding the nature and functionalities of computers.
        I wanted to be a Computer Engineer, but unfortunately,
         I had to step into a career as military officer.
