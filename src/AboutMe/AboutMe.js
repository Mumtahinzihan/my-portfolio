    ...
    return (
        ...
        <div className='about'>
            ...
            here you go:<br /><br />
              ...
              like I needed to do something else, something creative. <br />
                ...
                My mind kept saying "if i would be able to fulfill my aspired proffession". One day, out of curiosity, I decided to go to a Kodiri meet-up and was so impressed with the work they do,
                 which was coding. Websites, we think are so simple to look at, they require a lot of effort (and brainwork!)
              to make it look the way we want them to be - my fascination was grown insanely then.<br /><br />
